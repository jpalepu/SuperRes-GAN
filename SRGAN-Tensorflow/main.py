...
gan_model = create_comb(generator_model, discriminator_model, vgg, generator_input,discriminator_input)
...
plot_images("data/lr_images/im4.jpg", "data/hr_images/im4.jpg", generator_model)
...
lr_test_image = plt.imread("data/lr_images/im2.jpg")
hr_test_image = plt.imread("data/hr_images/im2.jpg")
...
calculate_psnr(hr_test_image, generated_hr)
